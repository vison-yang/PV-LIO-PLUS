...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  double vertical_angle_min, vertical_angle_max;
  double horizontal_angle_min, horizontal_angle_max;
  ...
  void solid_handler(const sensor_msgs::PointCloud2::ConstPtr &msg);
